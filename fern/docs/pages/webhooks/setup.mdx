...
async def handle_webhook(request: Request):
    ...
    match event["event_type"]:
        case "sync.completed":
            ...
            print(f"Sync completed: {collection} (job: {job_id})")
        ...
        case "sync.running":
            print(f"Sync started: {event['collection_name']}")
...
app.post("/webhooks/airweave", (req, res) => {
  ...
  switch (event.event_type) {
    case "sync.completed":
      console.log(`Sync completed: ${event.collection_name} (job: ${event.job_id})`);
      // Trigger your downstream workflow here
      break;
    ...
    case "sync.running":
      console.log(`Sync started: ${event.collection_name}`);
      break;
  }
