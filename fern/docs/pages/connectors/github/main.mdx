...
|-------|------|-------------|
| repo_id | int | Unique GitHub repository ID |
...
| Field | Type | Description |
|-------|------|-------------|
| full_path | str | Repository-qualified directory path (owner/repo/path) |
...
| Field | Type | Description |
|-------|------|-------------|
| full_path | str | Repository-qualified file path (owner/repo/path) |
| name | str | Filename |
...
|-------|------|-------------|
| full_path | str | Repository-qualified file path (owner/repo/path) |
| deletion_label | str | Human-readable deletion label |
