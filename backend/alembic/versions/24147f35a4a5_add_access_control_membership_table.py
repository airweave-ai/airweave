"""add_access_control_membership_table

Revision ID: 24147f35a4a5
Revises: d702ba6de953
Create Date: 2025-11-04 14:16:53.881833
...
def upgrade():
    ...
    # Unique constraint on source_connection_id (not source_name)
    op.create_index(
        "uq_acl_membership",
        "access_control_membership",
