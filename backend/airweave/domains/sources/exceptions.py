...
class SourceNotFoundError(NotFoundException):
    ...
    def __init__(self, short_name: str):
        """Initialize SourceNotFoundError for the given short_name."""
...
class SourceCreationError(Exception):
    ...
    def __init__(self, short_name: str, reason: str):
        """Initialize SourceCreationError with source name and reason."""
        self.short_name = short_name
        self.reason = reason
...
class SourceValidationError(Exception):
    ...
    def __init__(self, short_name: str, reason: str):
        """Initialize SourceValidationError with source name and reason."""
        self.short_name = short_name
        self.reason = reason
