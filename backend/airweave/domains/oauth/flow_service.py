...
Ported from:
- source_connection_service._create_with_oauth2_browser L877-908 (initiate_oauth2)
- source_connection_service._create_with_oauth1_browser L746-779 (initiate_oauth1)
- source_connection_service_helpers.exchange_oauth2_code L1271-1310 (complete_oauth2_callback)
- source_connection_service_helpers.exchange_oauth1_code L1239-1269 (complete_oauth1_callback)
- source_connection_service_helpers.create_init_session L1083-1213
- source_connection_service_helpers.create_proxy_url L1215-1237
"""
...
class OAuthFlowService:
    ...
    async def initiate_oauth2(
        ...
        *,
        ...
        Ported from source_connection_service._create_with_oauth2_browser L877-908.
    ...
    async def initiate_oauth1(
        ...
        *,
        ...
        Ported from source_connection_service._create_with_oauth1_browser L746-779.
    ...
    async def complete_oauth2_callback(
        ...
        Ported from source_connection_service_helpers.exchange_oauth2_code L1271-1310.
        """
        redirect_uri = (
    ...
    async def complete_oauth1_callback(
        ...
        Ported from source_connection_service_helpers.exchange_oauth1_code L1239-1269.
        """
    ...
    async def create_init_session(  # noqa: C901
        ...
        *,
        ...
        Ported from source_connection_service_helpers.create_init_session L1083-1213.
    ...
    async def create_proxy_url(
        ...
        Ported from source_connection_service_helpers.create_proxy_url L1215-1237.
