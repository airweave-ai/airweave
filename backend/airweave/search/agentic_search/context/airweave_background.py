"""Static Airweave background context for LLM prompts.

This provides the foundational context that explains how Airweave works.
Both the Planner and Judge use this to understand the system they're operating in.
"""
