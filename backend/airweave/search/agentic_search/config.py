...
class AgenticSearchConfig:
    ...
    # Embedders are now resolved by domains/embedders/ service (deployment-level config).
    # The sync pipeline and search use the same EmbedderService from the container.
