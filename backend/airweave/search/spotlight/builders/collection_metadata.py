...
class SpotlightCollectionMetadataBuilder:
    ...
    to construct the SpotlightCollectionMetadata schema.
    """
    ...
    async def build(self, collection_readable_id: str) -> SpotlightCollectionMetadata:
        ...
        Returns:
            SpotlightCollectionMetadata with all source metadata populated.
        """
        # 1. Get collection
        ...
        sources: list[SpotlightSourceMetadata] = []
        ...
        return SpotlightCollectionMetadata(
