...
class SpotlightPlanner:
    ...
    async def plan(self, state: SpotlightState) -> SpotlightPlan:
        ...
        plan = await self._llm.structured_output(
            user_prompt, SpotlightPlan, system_prompt=system_prompt
        )
...
This is iteration **{state.iteration_number}**."""
        ...
        history_info = SpotlightHistory.render_md(
...
Look at the history — which iterations found partially relevant content?
