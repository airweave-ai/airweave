...
export const SearchBox: React.FC<SearchBoxProps> = ({
  ...
  const [hoveredTooltipContent, setHoveredTooltipContent] = useState<
    string | null
  >(null);
  ...
  const [queriesCheckDetails, setQueriesCheckDetails] =
    useState<SingleActionCheckResponse | null>(null);
  ...
  const handleCancelSearch = useCallback(() => {
    ...
    if (controller) {
      console.log("[SearchBox] Aborting current stream", {
      ...
      try {
        onStreamEventProp?.({ type: "cancelled" } as any);
      } catch {
        void 0;
      }
      try {
        onStreamUpdateProp?.({ status: "cancelled" });
      } catch {
        void 0;
      }
      try {
  ...
  const checkQueriesAllowed = useCallback(async () => {
    try {
      ...
      const response = await apiClient.get(
        "/usage/check-action?action=queries"
      );
      if (response.ok) {
  ...
  const handleSendQuery = useCallback(async () => {
    ...
    try {
      ...
      if (typeof window !== "undefined") {
        if (
          window.localStorage.getItem(
            "airweave-debug-force-transient-search-error"
          ) === "true"
        ) {
          debugParams.set("debug_force_transient_error", "true");
        }
        if (
          window.localStorage.getItem("airweave-debug-force-search-error") ===
          "true"
        ) {
      ...
      const streamUrl = `/collections/${collectionId}/search/stream${
        debugQuery ? `?${debugQuery}` : ""
      }`;

      // Make the streaming API call
      const response = await apiClient.post(streamUrl, requestBody, {
            ...
            case "error": {
              ...
              if (event.transient === true) {
                ...
                setTransientIssue({
                  message:
                    errorMessage ||
                    "Search connection interrupted. Please try again.",
                  detail: event.detail,
                });
              ...
              setTransientIssue(null);
              onSearch(
                { error: errorMessage, errorIsTransient: false },
                currentResponseType,
                responseTime
              );
  ...
  const handleToggle = useCallback(
    (name: keyof SearchToggles, displayName: string) => {
  ...
  const handleRecencyBiasChange = useCallback(
    (value: number) => {
              ...
              <Tooltip>
                ...
                >
                  <div className="space-y-2">
                    <div className={DESIGN_SYSTEM.tooltip.title}>
                      Call the Search API
                    </div>
              ...
              <div className="flex items-center gap-1.5">
                  ...
                  >
                    ...
                    <Tooltip open={openTooltip === "hybrid"}>
                      ...
                      <TooltipContent
                        ...
                        arrowClassName={DESIGN_SYSTEM.tooltip.arrow}
                        onMouseEnter={() =>
                          handleTooltipContentMouseEnter("hybrid")
                        }
                        onMouseLeave={() =>
                          handleTooltipContentMouseLeave("hybrid")
                        }
                      >
                        <div className="space-y-2">
                          <div className={DESIGN_SYSTEM.tooltip.title}>
                          ...
                          <p className={DESIGN_SYSTEM.tooltip.description}>
                            Combines AI semantic and keyword signals for the
                    ...
                    <Tooltip open={openTooltip === "neural"}>
                      ...
                      <TooltipContent
                        ...
                        arrowClassName={DESIGN_SYSTEM.tooltip.arrow}
                        onMouseEnter={() =>
                          handleTooltipContentMouseEnter("neural")
                        }
                        onMouseLeave={() =>
                          handleTooltipContentMouseLeave("neural")
                        }
                      >
                        <div className="space-y-2">
                          <div className={DESIGN_SYSTEM.tooltip.title}>
                            Search method: Neural
                          </div>
                          <p className={DESIGN_SYSTEM.tooltip.description}>
                    ...
                    <Tooltip open={openTooltip === "keyword"}>
                        ...
                        <button
                          ...
                          onClick={
                            searchMethod === "keyword"
                              ? undefined
                              : () => handleMethodChange("keyword")
                          }
                          onMouseEnter={() =>
                            handleTooltipMouseEnter("keyword")
                          }
                          onMouseLeave={() =>
                            handleTooltipMouseLeave("keyword")
                          }
                          className={cn(
                            "aspect-square h-full flex items-center justify-center border",
                            DESIGN_SYSTEM.radius.button,
                      ...
                      <TooltipContent
                        ...
                        arrowClassName={DESIGN_SYSTEM.tooltip.arrow}
                        onMouseEnter={() =>
                          handleTooltipContentMouseEnter("keyword")
                        }
                        onMouseLeave={() =>
                          handleTooltipContentMouseLeave("keyword")
                        }
                      >
                        <div className="space-y-2">
                          <div className={DESIGN_SYSTEM.tooltip.title}>
                ...
                <Tooltip open={openTooltip === "queryExpansion"}>
                  <TooltipTrigger asChild>
                    <div
                      onMouseEnter={() =>
                        handleTooltipMouseEnter("queryExpansion")
                      }
                      onMouseLeave={() =>
                        handleTooltipMouseLeave("queryExpansion")
                      }
                      className={cn(
                        DESIGN_SYSTEM.buttons.heights.secondary,
                  ...
                  <TooltipContent
                    side="bottom"
                    className={cn(
                      DESIGN_SYSTEM.tooltip.content,
                      "max-w-[220px]"
                    )}
                    arrowClassName={DESIGN_SYSTEM.tooltip.arrow}
                    onMouseEnter={() =>
                      handleTooltipContentMouseEnter("queryExpansion")
                    }
                    onMouseLeave={() =>
                      handleTooltipContentMouseLeave("queryExpansion")
                    }
                  >
                    <div className="space-y-2">
                      <div className={DESIGN_SYSTEM.tooltip.title}>
                      ...
                      <p className={DESIGN_SYSTEM.tooltip.description}>
                        Generates similar versions of your query to improve
                        recall.
                      </p>
                      <div className={DESIGN_SYSTEM.tooltip.divider}>
                        <a
                ...
                <Tooltip open={openTooltip === "filter"}>
                  ...
                  <TooltipContent
                    ...
                    arrowClassName={DESIGN_SYSTEM.tooltip.arrow}
                    onMouseEnter={() =>
                      handleTooltipContentMouseEnter("filter")
                    }
                    onMouseLeave={() =>
                      handleTooltipContentMouseLeave("filter")
                    }
                  >
                    <div className="space-y-3">
                      <div>
                        ...
                        <p
                          className={cn(
                            DESIGN_SYSTEM.tooltip.description,
                            "mt-1"
                          )}
                        >
                          Filter by fields like source, status, or date before
                          searching.
                        </p>
                      </div>
                ...
                <Tooltip open={openTooltip === "queryInterpretation"}>
                  <TooltipTrigger asChild>
                    <div
                      onMouseEnter={() =>
                        handleTooltipMouseEnter("queryInterpretation")
                      }
                      onMouseLeave={() =>
                        handleTooltipMouseLeave("queryInterpretation")
                      }
                      className={cn(
                        DESIGN_SYSTEM.buttons.heights.secondary,
                        "w-8 p-0 overflow-hidden border",
                  ...
                  <TooltipContent
                    ...
                    arrowClassName={DESIGN_SYSTEM.tooltip.arrow}
                    onMouseEnter={() =>
                      handleTooltipContentMouseEnter("queryInterpretation")
                    }
                    onMouseLeave={() =>
                      handleTooltipContentMouseLeave("queryInterpretation")
                    }
                  >
                    <div className="space-y-2">
                      <div className={DESIGN_SYSTEM.tooltip.title}>
                      ...
                      <p className={DESIGN_SYSTEM.tooltip.description}>
                        Auto-extracts filters from natural language. May be
                        over‑restrictive.
                      </p>
                      <div className={DESIGN_SYSTEM.tooltip.divider}>
                        <a
                ...
                <Tooltip open={openTooltip === "recencyBias"}>
                  <TooltipTrigger asChild>
                    <div
                      onMouseEnter={() =>
                        handleTooltipMouseEnter("recencyBias")
                      }
                      onMouseLeave={() =>
                        handleTooltipMouseLeave("recencyBias")
                      }
                      className={cn(
                        DESIGN_SYSTEM.buttons.heights.secondary,
                        "w-8 p-0 overflow-hidden border",
                  ...
                  <TooltipContent
                    ...
                    arrowClassName={DESIGN_SYSTEM.tooltip.arrow}
                    onMouseEnter={() =>
                      handleTooltipContentMouseEnter("recencyBias")
                    }
                    onMouseLeave={() =>
                      handleTooltipContentMouseLeave("recencyBias")
                    }
                  >
                    <div className="space-y-2">
                      <div className={DESIGN_SYSTEM.tooltip.title}>
                      ...
                      <p className={DESIGN_SYSTEM.tooltip.description}>
                        Prioritize recent documents. Higher values give more
                        weight to newer content.
                      </p>
                ...
                <Tooltip open={openTooltip === "reRanking"}>
                  ...
                  <TooltipContent
                    ...
                    arrowClassName={DESIGN_SYSTEM.tooltip.arrow}
                    onMouseEnter={() =>
                      handleTooltipContentMouseEnter("reRanking")
                    }
                    onMouseLeave={() =>
                      handleTooltipContentMouseLeave("reRanking")
                    }
                  >
                    <div className="space-y-2">
                      <div className={DESIGN_SYSTEM.tooltip.title}>
                      ...
                      <p className={DESIGN_SYSTEM.tooltip.description}>
                        LLM reorders results for better relevance.
                      </p>
                      <div className={DESIGN_SYSTEM.tooltip.divider}>
                        <a
                ...
                <Tooltip open={openTooltip === "answer"}>
                  ...
                  <TooltipContent
                    ...
                    arrowClassName={DESIGN_SYSTEM.tooltip.arrow}
                    onMouseEnter={() =>
                      handleTooltipContentMouseEnter("answer")
                    }
                    onMouseLeave={() =>
                      handleTooltipContentMouseLeave("answer")
                    }
                  >
                    <div className="space-y-2">
                      <div className={DESIGN_SYSTEM.tooltip.title}>
                      ...
                      <p className={DESIGN_SYSTEM.tooltip.description}>
                        Returns an AI-written answer instead of raw results when
                        enabled.
                      </p>
                      <div className={DESIGN_SYSTEM.tooltip.divider}>
                        <a
      ...
      {showCodeBlock && collectionId && (
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-8 pointer-events-none">
            <div
              className={cn("relative w-full max-w-4xl pointer-events-auto")}
              onClick={(e) => e.stopPropagation()}
            >
              {/* Close button */}
              <button
